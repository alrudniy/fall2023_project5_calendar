...
<div class="right">
  <h1><center>Generate your class schedule</center></h1>
    <form method="post" action="upload.php">
        Class name: <input type="text" id="name" name="name" placeholder="CSCI 150" required><br><br/>
        ...
        When does class meet: <select id="meeting_date" name="meeting_date" size="5" multiple required>
        ...
        What dates do you not want to include? <input type="text" id="exception"name="exception" placeholder="mmddyyyy">
        <p> 
          <span class="special"> ** </span>
