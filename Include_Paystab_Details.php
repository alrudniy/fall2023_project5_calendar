...
// verification if URL was not forget, i.e. non-manager tries to forge parameters to view another person's data
if ($_SESSION['Role'] != 'Manager'){
    die('Access Denied. Access allowed to managers only!');
}
                    ...
                    <div class="panel-heading">
                        <div class="pull-left">
                            ...
                            <form><input class="btnstylega"
                                         onclick="window.open('Print_View_Manager.php?uid=<?php echo $eID; ?> ','mywindow', 'menubar=1,resizable=1,width=500,height=500')"
